...
mod test {
    ...
    fn test_encoder_normal() {
        ...
        assert_eq!(
            c.encode_with_encoding("GBK").unwrap(),
            vec!(0xb9, 0xfe, 0xb9, 0xfe)
        );
    }
    ...
    fn test_decoder_fail_creating_converter() {
        ...
        let b = &buf[..];
        assert_eq!(
            b.decode_with_encoding("NOT_EXSITS").unwrap(),
            "".to_string()
        );
    }
    ...
    fn test_caocao_joke() {
        ...
        let b = "变巨";
        assert_eq!(
            a.encode_with_encoding("BIG5").unwrap(),
